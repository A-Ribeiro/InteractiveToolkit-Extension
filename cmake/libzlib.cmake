...
if(LIB_ZLIB STREQUAL FromSource)
    ...
    tool_make_global(ZLIB_INCLUDE_DIRS)
    tool_make_global(ZLIB_LIBRARY)
    tool_make_global(ZLIB_LIBRARIES)
    tool_make_global(ZLIB_FOUND)
...
if(NOT TARGET zlibstatic)
    ...
    target_link_libraries(zlibstatic INTERFACE zlib)
endif()
# set_target_properties(zlib PROPERTIES LINKER_LANGUAGE CXX)
# set_target_properties(zlib PROPERTIES FOLDER "LIBS")
# target_include_directories(zlib INTERFACE ${ZLIB_INCLUDE_DIR})
...
# set_target_properties(libzlib PROPERTIES LINKER_LANGUAGE CXX)
# set_target_properties(libzlib PROPERTIES FOLDER "LIBS")
# target_include_directories(libzlib INTERFACE ${ZLIB_INCLUDE_DIR})
