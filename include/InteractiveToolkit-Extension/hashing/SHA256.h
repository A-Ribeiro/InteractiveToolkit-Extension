...
namespace ITKExtension
{
    namespace Hashing
    {
        typedef uint8_t DigestArray32_T[32];
        ...
        public:
            ...
            static void hash(const uint8_t *data, size_t len, uint8_t **digest_output);
            static void hash(const uint8_t *data, size_t len, DigestArray32_T *digest_output);
            static void hashFromFile(const char *filepath, uint8_t *digest_output, std::string *errorStr = nullptr);
            static void hashFromFile(const char *filepath, uint8_t **digest_output, std::string *errorStr = nullptr);
            static void hashFromFile(const char *filepath, DigestArray32_T *digest_output, std::string *errorStr = nullptr);
