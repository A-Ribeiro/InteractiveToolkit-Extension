...
namespace ITKExtension
{
    namespace Model
    {
        ...
        static const char *TextureOpToStr(TextureOp op)
        {
            switch (op)
            {
            case TextureOp_Multiply:
                return "multiply";
            case TextureOp_Add:
                return "add";
            case TextureOp_Subtract:
                return "subtract";
            case TextureOp_Divide:
                return "divide";
            case TextureOp_SmoothAdd:
                return "smooth add";
            case TextureOp_SignedAdd:
                return "signed add";
            case TextureOp_Default:
                return "default";
            }
            return "error to parse";
        }
        ...
        static const char *TextureMapModeToStr(TextureMapMode map)
        {
            switch (map)
            {
            case TextureMapMode_Wrap:
                return "wrap";
            case TextureMapMode_Clamp:
                return "clamp";
            case TextureMapMode_Decal:
                return "decal";
            case TextureMapMode_Mirror:
                return "mirror";
            }
            return "error to parse";
        }
